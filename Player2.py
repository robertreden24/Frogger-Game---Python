...
class Player2(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        #load sprite image
        self.image = pygame.image.load("images/turtlestill.png")
        self.rect = self.image.get_rect()

        #load the sprite at this position
        self.rect.center = (260,620)

        # sprite movement dictionaries
        self.image_up = {1: "images/turtlestill.png", -1: "images/turtlewalk.png"}
        self.image_down = {1: "images/turtlestillback.png", -1: "images/turtlewalkback.png"}
        self.image_right = {1: "images/turtleright.png", -1: "images/turtlewalkright.png"}
        self.image_left = {1: "images/turtleleft.png", -1: "images/turtlewalkleft.png"}
